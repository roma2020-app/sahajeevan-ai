...
interface ActiveMomentCardProps {
  ...
  interest?: string;
  onComplete: (reflectionText?: string) => Promise<void>;
  onReset: () => void;
  isSaving: boolean;
}
      ...
      {showReflectionModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-xs">
          <div className="bg-white rounded-2xl p-6 sm:p-8 max-w-md w-full border border-[#EAE6DF] shadow-xl animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="mb-6">
              <label className="block text-xs font-semibold uppercase tracking-wider text-[#7A766F] mb-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full p-3 text-sm rounded-xl border border-[#D8D2C7] bg-[#FAF8F4] focus:outline-none focus:ring-2 focus:ring-[#2E5A44]/20 focus:border-[#2E5A44]"
              />
            </div>
